  ...
  return (
    <div className="myBG">
          ...
          <Row>
            <Col lg={7} className="col-left">
              ...
              <div className="text-thin">
                <div className="melangkah">“Melangkah Bersama: Indonesia Emas 2045, Sebuah</div>
                <div className="perjalanan">Perjalanan Menuju Persatuan dan Kesatuan”</div>
              </div>
            </Col>
      ...
      <Container>
            ...
            <Col>
              <Card style={{ width: "18rem" }} className="fitur1">
                <Card.Body>
                  ...
                  <Card.Subtitle className="mb-2 title-cek">Cek Berita</Card.Subtitle>
                  <Card.Text>Fitur pengecekan berita berbasis AI untuk mengetahui berita hoax dan hate speech selama Pemilu.</Card.Text>
            ...
            <Col>
              <Card style={{ width: "18rem" }} className="fitur2">
                <Card.Body>
                  ...
                  <Card.Subtitle className="mb-2 title-lapor">Lapor Berita</Card.Subtitle>
                  <Card.Text>Sarana masyarakat untuk melaporkan berita hoax dan hate speech selama Pemilu</Card.Text>
                  <Card.Link href="cekberita" className="gr-button">
        ...
        <div className="indo-bebas">"Indonesia Emas, Terbebas dari Hoax dan Hate Speech."</div>
      </Container>
